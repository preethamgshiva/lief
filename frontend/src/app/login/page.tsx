    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Welcome to Lief Care Management</h1>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              <p className="text-gray-600 mb-4">
                Access management tools, reports, and administrative functions.
              </p>
              <Link
                href="/manager"
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="bg-green-600 p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-white">Care Worker</h2>
            ...
            <div className="p-6">
              <p className="text-gray-600 mb-4">
                Access your care worker portal for time tracking and daily tasks.
              </p>
              <Link
                href="/care-worker"
                className="w-full px-6 py-3 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition-colors flex items-center justify-center space-x-2"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
                <span>Go to Care Worker Portal</span>
              </Link>
            </div>
          </div>
        </div>
